...
#define PIN_06_PIN      FIO_PIN_ZERO

// Pin 07 - NOT USED    //GMAN2_EN
#define PIN_07_DIR      FIO_DIR_OUTPUT
#define PIN_07_MASK     FIO_NOT_MASKED
#define PIN_07_SEL      PINSEL_GPIO
#define PIN_07_PIN      FIO_PIN_ZERO

// Pin 08 - TEST_MODE    //GMAN1_EN
#define PIN_08_DIR      FIO_DIR_INPUT
#define PIN_08_MASK     FIO_NOT_MASKED
#define PIN_08_SEL      PINSEL_GPIO
#define PIN_08_PIN      FIO_PIN_ONE

// Pin 09 - SOUND_OUT // GMAN1
#define PIN_09_DIR      FIO_DIR_INPUT
#define PIN_09_MASK     FIO_MASKED
#define PIN_09_SEL      PINSEL_FUNC2
#define PIN_09_PIN      FIO_PIN_ZERO

// Pin 10 - PWR_CONTR //FB_SOUND
#define PIN_10_DIR      FIO_DIR_OUTPUT
#define PIN_10_MASK     FIO_NOT_MASKED
#define PIN_10_SEL      PINSEL_GPIO
#define PIN_10_PIN      FIO_PIN_ZERO

// Pin 11 - RMAN_EN     //FB_BRIGHT
#define PIN_11_DIR      FIO_DIR_OUTPUT
#define PIN_11_MASK     FIO_NOT_MASKED
#define PIN_11_SEL      PINSEL_GPIO
...
// Pin 17 - SLF
#define PIN_17_DIR      FIO_DIR_INPUT //FIO_DIR_OUTPUT
#define PIN_17_MASK     FIO_NOT_MASKED
#define PIN_17_SEL      PINSEL_GPIO
#define PIN_17_PIN      FIO_PIN_ONE   //FIO_PIN_ZERO
...
// Pin 22 - LIGHT_SENS (AD0)
#define PIN_22_DIR      FIO_DIR_INPUT
#define PIN_22_MASK     FIO_MASKED
#define PIN_22_SEL      PINSEL_FUNC3
#define PIN_22_PIN      FIO_PIN_ZERO
...
#define SHB_MASK          0//0x00000010UL
...
#define S1_MASK           0x00000040UL

#define SEG_ALL_MASK      (SH_MASK|SL_MASK|S1_MASK)

#define RMAN_EN_MASK      0x00000800UL
#define GMAN0_EN_MASK     0x00001000UL
#define GMAN1_EN_MASK     0x00000000UL
#define GMAN2_EN_MASK     0x00000000UL

// MASTER SETTINGS+
#define RMAN_MASK         (RMAN_EN_MASK|SHA_MASK|SHC_MASK|SHD_MASK|SHE_MASK|SHF_MASK|SHG_MASK|S1_MASK|SL_MASK)
#define GMAN0_MASK        (GMAN0_EN_MASK)
#define GMAN1_MASK        0
#define GMAN2_MASK        0
// MASTER SETTINGS-

// SLAVE SETTINGS+
//#define RMAN_MASK         (RMAN_EN_MASK)
//#define GMAN0_MASK        (GMAN0_EN_MASK|SHA_MASK|SHB_MASK|SHC_MASK|SHD_MASK|SHE_MASK)
//#define GMAN1_MASK        (SHF_MASK|SHG_MASK|S1_MASK)
//#define GMAN2_MASK        (SLD_MASK|SLE_MASK|SLF_MASK|SLG_MASK)
// SLAVE SETTINGS-


#define GMAN_ALL_MASK     (GMAN0_MASK|GMAN1_MASK|GMAN2_MASK)
#define YELLOW_MASK       0x00UL


#define LED1_MASK         0x00800000UL
#define LED2_MASK         0x00000000UL
#define ALL_LEDS_MASK     (LED1_MASK|LED2_MASK)


#define SOUND_OUT_MASK    0x00UL


#define RED_IN_MASK       0x00100000UL
#define GREEN_IN_MASK     0x00200000UL
#define YELLOW_IN_MASK    0x00UL
#define TEST_IN_MASK      0x00000100UL


#define DIRECT_MASK       (SEG_ALL_MASK|RMAN_MASK|GMAN_ALL_MASK|YELLOW_MASK|ALL_LEDS_MASK|SOUND_OUT_MASK)
#define OFF_MASK          (LED1_MASK|LED2_MASK)

#define PWR_CONTR_MASK    0x00000400UL
/*--------------------------------------*/
...
#define ADC_LIGHT_SENS_CHANNEL 0
